package com.venx.microservices.gateway.routes;
...
public class Routes {
    ...
    /*
    Spring boot çalıştığı sürece tüm istekler için öncelikle RouterFunction ile istekleri denetler eğer uyuşan varsa diğer mikroservislerden önce davranarak gateway ile yönlendirme yapar sistemin yapısı boyle çalışıyor
     */
    ...
    public RouterFunction<ServerResponse> fallbackRoute() {
        return route("fallbackRoute")
                .GET("/fallbackRoute", request -> ServerResponse.status(HttpStatus.SERVICE_UNAVAILABLE)
                        .body("Service Unavaiable, please try again later"))
                .build();
